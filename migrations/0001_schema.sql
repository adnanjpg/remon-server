...
CREATE TABLE metrics_cpu (
    -- v1 preserves observed extrema and per-field sums/counts; NULL means legacy.
    summary_version INTEGER,
    usage_percent_min REAL,
    usage_percent_max REAL,
    usage_percent_sum REAL,
    usage_percent_valid_count INTEGER,
    load_1m_min REAL,
    load_1m_max REAL,
    load_1m_sum REAL,
    load_1m_valid_count INTEGER,
    load_5m_min REAL,
    load_5m_max REAL,
    load_5m_sum REAL,
    load_5m_valid_count INTEGER,
    load_15m_min REAL,
    load_15m_max REAL,
    load_15m_sum REAL,
    load_15m_valid_count INTEGER,
    steal_percent_min REAL,
    steal_percent_max REAL,
    steal_percent_sum REAL,
    steal_percent_valid_count INTEGER,
    iowait_percent_min REAL,
    iowait_percent_max REAL,
    iowait_percent_sum REAL,
    iowait_percent_valid_count INTEGER,
    guest_percent_min REAL,
    guest_percent_max REAL,
    guest_percent_sum REAL,
    guest_percent_valid_count INTEGER,
    user_percent_min REAL,
    user_percent_max REAL,
    user_percent_sum REAL,
    user_percent_valid_count INTEGER,
    system_percent_min REAL,
    system_percent_max REAL,
    system_percent_sum REAL,
    system_percent_valid_count INTEGER,
    context_switches_per_sec_min REAL,
    context_switches_per_sec_max REAL,
    context_switches_per_sec_sum REAL,
    context_switches_per_sec_valid_count INTEGER,
    process_forks_per_sec_min REAL,
    process_forks_per_sec_max REAL,
    process_forks_per_sec_sum REAL,
    process_forks_per_sec_valid_count INTEGER,
...
CREATE TABLE metrics_memory (
    used_percent REAL,
    summary_version INTEGER,
    total_bytes_min REAL,
    total_bytes_max REAL,
    total_bytes_sum REAL,
    total_bytes_valid_count INTEGER,
    used_bytes_min REAL,
    used_bytes_max REAL,
    used_bytes_sum REAL,
    used_bytes_valid_count INTEGER,
    available_bytes_min REAL,
    available_bytes_max REAL,
    available_bytes_sum REAL,
    available_bytes_valid_count INTEGER,
    cached_bytes_min REAL,
    cached_bytes_max REAL,
    cached_bytes_sum REAL,
    cached_bytes_valid_count INTEGER,
    swap_used_bytes_min REAL,
    swap_used_bytes_max REAL,
    swap_used_bytes_sum REAL,
    swap_used_bytes_valid_count INTEGER,
    page_faults_minor_per_sec_min REAL,
    page_faults_minor_per_sec_max REAL,
    page_faults_minor_per_sec_sum REAL,
    page_faults_minor_per_sec_valid_count INTEGER,
    page_faults_major_per_sec_min REAL,
    page_faults_major_per_sec_max REAL,
    page_faults_major_per_sec_sum REAL,
    page_faults_major_per_sec_valid_count INTEGER,
    swap_in_pages_per_sec_min REAL,
    swap_in_pages_per_sec_max REAL,
    swap_in_pages_per_sec_sum REAL,
    swap_in_pages_per_sec_valid_count INTEGER,
    swap_out_pages_per_sec_min REAL,
    swap_out_pages_per_sec_max REAL,
    swap_out_pages_per_sec_sum REAL,
    swap_out_pages_per_sec_valid_count INTEGER,
    used_percent_min REAL,
    used_percent_max REAL,
    used_percent_sum REAL,
    used_percent_valid_count INTEGER,
    resolution                 TEXT    NOT NULL REFERENCES resolutions(name),
    timestamp                  INTEGER NOT NULL,
...
CREATE TABLE metrics_disk (
    ...
    available_bytes_sum REAL,
    available_bytes_valid_count INTEGER,
    read_bytes_per_sec_min REAL,
    read_bytes_per_sec_max REAL,
    read_bytes_per_sec_sum REAL,
    read_bytes_per_sec_valid_count INTEGER,
    write_bytes_per_sec_min REAL,
    write_bytes_per_sec_max REAL,
    write_bytes_per_sec_sum REAL,
    write_bytes_per_sec_valid_count INTEGER,
    inode_used_percent_min REAL,
    inode_used_percent_max REAL,
    inode_used_percent_sum REAL,
    inode_used_percent_valid_count INTEGER,
    read_iops_min REAL,
    read_iops_max REAL,
    read_iops_sum REAL,
    read_iops_valid_count INTEGER,
    write_iops_min REAL,
    write_iops_max REAL,
    write_iops_sum REAL,
    write_iops_valid_count INTEGER,
    io_util_percent_min REAL,
    io_util_percent_max REAL,
    io_util_percent_sum REAL,
    io_util_percent_valid_count INTEGER,
    used_percent_min REAL,
    used_percent_max REAL,
    used_percent_sum REAL,
    used_percent_valid_count INTEGER,
...
CREATE TABLE metrics_network (
    summary_version INTEGER,
    rx_bytes_per_sec_min REAL,
    rx_bytes_per_sec_max REAL,
    rx_bytes_per_sec_sum REAL,
    rx_bytes_per_sec_valid_count INTEGER,
    tx_bytes_per_sec_min REAL,
    tx_bytes_per_sec_max REAL,
    tx_bytes_per_sec_sum REAL,
    tx_bytes_per_sec_valid_count INTEGER,
    rx_packets_per_sec_min REAL,
    rx_packets_per_sec_max REAL,
    rx_packets_per_sec_sum REAL,
    rx_packets_per_sec_valid_count INTEGER,
    tx_packets_per_sec_min REAL,
    tx_packets_per_sec_max REAL,
    tx_packets_per_sec_sum REAL,
    tx_packets_per_sec_valid_count INTEGER,
    errors_in_per_sec_min REAL,
    errors_in_per_sec_max REAL,
    errors_in_per_sec_sum REAL,
    errors_in_per_sec_valid_count INTEGER,
    errors_out_per_sec_min REAL,
    errors_out_per_sec_max REAL,
    errors_out_per_sec_sum REAL,
    errors_out_per_sec_valid_count INTEGER,
    resolution         TEXT    NOT NULL REFERENCES resolutions(name),
    timestamp          INTEGER NOT NULL,
...
-- Snapshot totals exclude encapsulating tunnels to avoid counting traffic twice.
-- Shares network's rollup cursor and retention policy.
CREATE TABLE metrics_network_total (
    resolution TEXT NOT NULL REFERENCES resolutions(name),
    timestamp INTEGER NOT NULL,
    rx_bytes_per_sec INTEGER NOT NULL,
    tx_bytes_per_sec INTEGER NOT NULL,
    rx_packets_per_sec INTEGER NOT NULL,
    tx_packets_per_sec INTEGER NOT NULL,
    errors_in_per_sec INTEGER NOT NULL,
    errors_out_per_sec INTEGER NOT NULL,
    sample_count INTEGER,
    summary_version INTEGER,
    rx_bytes_per_sec_min REAL,
    rx_bytes_per_sec_max REAL,
